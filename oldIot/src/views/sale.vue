...
<!--        </el-col>-->
    ...
    <el-dialog
      ...
      <el-form label-width="80px" :model="customerForm" :rules="rules"  ref="addcustomerFormRef">
        <el-form-item label="销售商" prop="sname">
          <el-input v-model="customerForm.sname"></el-input>
        </el-form-item>
        <el-form-item label="电话" prop="saccount">
          <el-input v-model="customerForm.saccount"></el-input>
        </el-form-item>
		<el-form-item label="邮件" prop="semail">
		<el-input v-model="customerForm.semail"></el-input>
		</el-form-item>
		<el-form-item label="注册时间" prop="stime">
		<el-input v-model="customerForm.stime"></el-input>
		</el-form-item>
    ...
    <el-dialog
      ...
      <el-form label-width="80px" :rules="rules" :model="oldEditForm">
        <el-form-item label="销售商" prop="sname">
        <el-input v-model="oldEditForm.sname"></el-input>
        </el-form-item>
<!--				<el-form-item label="姓名" prop="customerId" style="display: none;">-->
<!--				<el-input v-model="oldEditForm.customerId"></el-input>-->
<!--				</el-form-item>-->
<!--        <el-form-item label="电话" prop="saccount">-->
<!--        <el-input v-model="oldEditForm.saccount"></el-input>-->
<!--        </el-form-item>-->
<!--        <el-form-item label="邮箱" prop="semail">-->
<!--        <el-radio-group v-model="oldEditForm.semail">-->
<!--        <el-radio label="男"></el-radio>-->
<!--        <el-radio label="女"></el-radio>-->
<!--        </el-radio-group>-->
<!--        </el-form-item>-->
        <el-form-item label="邮箱" prop="semail">
        <el-input v-model="oldEditForm.semail"></el-input>
        </el-form-item>
        <el-form-item label="注册时间" prop="stime">
        <el-input v-model="oldEditForm.stime"></el-input>
        </el-form-item>
      </el-form>
      <span slot="footer" class="dialog-footer">
    ...
    <!-- 可展开行 -->
      ...
      <el-table-column prop="sname" label="销售商" width="170" align="center"></el-table-column>
      <el-table-column prop="saccount" label="电话" width="170" align="center"></el-table-column>
	  <el-table-column prop="semail" label="邮箱" width="170" align="center"></el-table-column>
	  <el-table-column prop="stime" label="注册时间" width="170" align="center"></el-table-column>
<!--	  <el-table-column prop="customerAddress" label="地址" width="170" align="center"></el-table-column>-->
      <el-table-column label="操作" align="center">
        <template slot-scope="scope">
          ...
          <el-button size="mini" plain type="danger" icon="el-icon-delete" @click="deleteRole(scope.row.saccount)">删除
          </el-button>
...
export default {
  ...
  methods: {
    ...
    searchCustomers () {
       ...
       axios.post('restful/sale/selectAll',
         {
         ...
         _this.customerList = response.data.sales
         _this.total = response.data.sales.length
    ...
    editRole () {
      var _this = this
      axios.post('restful/sale/update', _this.oldEditForm,
        {
          headers: {
            'content-type': 'application/json'
          },
    ...
    async deleteRole (saccount) {
      ...
      try {
        ...
        axios.post('restful/sale/deleteByAccount', {'saccount': saccount},
          {
            headers: {
              'content-type': 'application/json'
            },
