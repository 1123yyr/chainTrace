...
export default {
    ...
    tabRemove (targetName) {
      ...
      if (this.activeIndex === targetName) {
        ...
        if (this.openTab && this.openTab.length >= 1) {
          ...
          this.$router.push({path: '/saleMain'})
        }
      }
    }
  },
  mounted () {
    ...
    if (this.$route.path !== '/saleMain' && this.$route.path !== '/SaleHome') {
      console.log('1')
      this.$store.commit('add_tabs', {route: '/saleMain', name: '销售商首页'})
      ...
      console.log('2')
      this.$store.commit('add_tabs', {route: '/saleMain', name: '销售商首页'})
      this.$store.commit('set_active_index', '/saleMain')
      // this.$router.push('/')
