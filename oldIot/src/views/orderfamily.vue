...
<!--          </el-input>-->
        ...
        <el-col :span="4">
          <el-button plain @click="customerDialogVisible = true">创建订单请求</el-button>
        </el-col>
      </el-row>
    </div>
...
<!--              style="width: 100%" border>-->
      ...
      <el-table-column prop="money" label="费用" width="140" align="center"></el-table-column>
...
// 			console.log(this.value6[1])
      axios.post('restful/cost/familyOrdershow',
        {
          "oldId":oldId
        },
        {
        ...
        _this.oldsList = response.data.order
    ...
    addFamily () {
      var _this = this
      axios.post('restful/cost/familyadd',
        _this.familyForm,
        {
          headers: {
            'content-type': 'application/json'
    ...
    editFamily () {
      var _this = this
      axios.post('restful/cost/familyupdateCost', _this.familyEditForm,
        {
          headers: {
            'content-type': 'application/json'
          },
