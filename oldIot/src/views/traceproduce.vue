...
<!--        <el-form-item label="订单id" prop="traid">-->
...
<!--        </el-form-item>-->
        <el-form-item label="生产地址" prop="paddress">
          <el-input v-model="familyEditForm.paddress"></el-input>
        </el-form-item>
        <!--        <el-form-item label="事件" prop="thing" style="display: none;">-->
        <el-form-item label="负责人" prop="pperson" >
          <el-input v-model="familyEditForm.pperson"></el-input>
        </el-form-item>
        <el-form-item label="生产时间" prop="ptime">
          <el-input v-model="familyEditForm.ptime"></el-input>
        </el-form-item>
<!--        <el-form-item label="费用(元)" prop="money">-->
...
<!--              style="width: 100%" border>-->
      ...
      <el-table-column prop="traid" label="ID" width="140" align="center"></el-table-column>
      <el-table-column prop="pname" label="生产商" width="140" align="center"></el-table-column>
      <el-table-column prop="paddress" label="生产地址" width="140" align="center"></el-table-column>
      <el-table-column prop="pperson" label="生产负责人" width="140" align="center"></el-table-column>
      <el-table-column prop="ptime" label="生产时间" width="140" align="center"></el-table-column>
...
// 			console.log(this.value6[1])
    ...
    addFamily () {
      var _this = this
      _this.familyForm.pname=localStorage.getItem('user_produce')
      axios.post('restful/trace/produceAdd',
        _this.familyForm,
        {
          headers: {
            'content-type': 'application/json'
    ...
    editFamily () {
      var _this = this
      _this.familyEditForm.pname=localStorage.getItem('user_produce')
      axios.post('restful/trace/produceUpdate', _this.familyEditForm,
        {
          headers: {
            'content-type': 'application/json'
          },
