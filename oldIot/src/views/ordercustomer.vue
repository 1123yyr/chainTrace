...
// 			console.log(this.value6[1])
      axios.post('restful/customer/findAllCostByCustomerId',
        {
        ...
        _this.oldsList = response.data.customers
    ...
    editFamily () {
      var _this = this
      axios.post('restful/cost/customerupdateCost', _this.familyEditForm,
        {
          headers: {
            'content-type': 'application/json'
          },
