...
<!--        </el-col>-->
    ...
    <el-dialog
      ...
      <el-form label-width="80px" :model="customerForm" :rules="rules"  ref="addcustomerFormRef">
        <el-form-item label="运输商" prop="tname">
          <el-input v-model="customerForm.tname"></el-input>
        </el-form-item>
        <el-form-item label="电话" prop="taccount">
          <el-input v-model="customerForm.taccount"></el-input>
        </el-form-item>
		<el-form-item label="邮件" prop="temail">
		<el-input v-model="customerForm.temail"></el-input>
		</el-form-item>
		<el-form-item label="注册时间" prop="ttime">
		<el-input v-model="customerForm.ttime"></el-input>
		</el-form-item>
    ...
    <el-dialog
      ...
      <el-form label-width="80px" :rules="rules" :model="oldEditForm">
        <el-form-item label="运输商" prop="tname">
        <el-input v-model="oldEditForm.tname"></el-input>
        </el-form-item>
<!--				<el-form-item label="姓名" prop="customerId" style="display: none;">-->
<!--				<el-input v-model="oldEditForm.customerId"></el-input>-->
<!--				</el-form-item>-->
<!--        <el-form-item label="电话" prop="taccount">-->
<!--        <el-input v-model="oldEditForm.taccount"></el-input>-->
<!--        </el-form-item>-->
<!--        <el-form-item label="邮箱" prop="temail">-->
<!--        <el-radio-group v-model="oldEditForm.temail">-->
<!--        <el-radio label="男"></el-radio>-->
<!--        <el-radio label="女"></el-radio>-->
<!--        </el-radio-group>-->
<!--        </el-form-item>-->
        <el-form-item label="邮箱" prop="temail">
        <el-input v-model="oldEditForm.temail"></el-input>
        </el-form-item>
        <el-form-item label="注册时间" prop="ttime">
        <el-input v-model="oldEditForm.ttime"></el-input>
        </el-form-item>
      </el-form>
      <span slot="footer" class="dialog-footer">
    ...
    <!-- 可展开行 -->
      ...
      <el-table-column prop="tname" label="运输商" width="170" align="center"></el-table-column>
      <el-table-column prop="taccount" label="电话" width="170" align="center"></el-table-column>
	  <el-table-column prop="temail" label="邮箱" width="170" align="center"></el-table-column>
	  <el-table-column prop="ttime" label="注册时间" width="170" align="center"></el-table-column>
<!--	  <el-table-column prop="customerAddress" label="地址" width="170" align="center"></el-table-column>-->
      <el-table-column label="操作" align="center">
        <template slot-scope="scope">
          ...
          <el-button size="mini" plain type="danger" icon="el-icon-delete" @click="deleteRole(scope.row.taccount)">删除
          </el-button>
...
export default {
  ...
  methods: {
    ...
    searchCustomers () {
       ...
       axios.post('restful/transport/selectAll',
         {
         ...
         _this.customerList = response.data.transports
         _this.total = response.data.transports.length
    ...
    addRoles () {
      var _this = this
      axios.post('restful/transport/add',
        _this.customerForm,
        {
          headers: {
            'content-type': 'application/json'
    ...
    editRole () {
      var _this = this
      axios.post('restful/transport/update', _this.oldEditForm,
        {
          headers: {
            'content-type': 'application/json'
          },
    ...
    async deleteRole (taccount) {
      ...
      try {
        ...
        axios.post('restful/transport/deleteByAccount', {'taccount': taccount},
          {
            headers: {
              'content-type': 'application/json'
            },
