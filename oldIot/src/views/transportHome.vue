...
export default {
    ...
    tabRemove (targetName) {
      ...
      if (this.activeIndex === targetName) {
        ...
        if (this.openTab && this.openTab.length >= 1) {
          ...
          this.$router.push({path: '/transportMain'})
        }
      }
    }
  },
  mounted () {
    ...
    if (this.$route.path !== '/transportMain' && this.$route.path !== '/TransportHome') {
      console.log('1')
      this.$store.commit('add_tabs', {route: '/transportMain', name: '运输商首页'})
      ...
      console.log('2')
      this.$store.commit('add_tabs', {route: '/transportMain', name: '运输商首页'})
      this.$store.commit('set_active_index', '/transportMain')
      // this.$router.push('/')
