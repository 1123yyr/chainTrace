<template>
  ...
  <div>
      <el-form label-width="80px" :model="customerForm" :rules="rules"  ref="addcustomerFormRef">
        <el-form-item label="新密码" prop="tpassword1">
          <el-input v-model="customerForm.tpassword1"></el-input>
        </el-form-item>
        <el-form-item label="再次输入" prop="tpassword2">
          <el-input v-model="customerForm.tpassword2"></el-input>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    addRoles () {
      var _this = this
      if (_this.customerForm.tpassword1 == _this.customerForm.tpassword2 && this.customerForm.tpassword1 !="" && _this.customerForm.tpassword1 !=null) {
        _this.customerForm.tpassword =_this.customerForm.tpassword1
        _this.customerForm.taccount=localStorage.getItem('taccount')
        axios.post('restful/transport/updatePassword',
          _this.customerForm,
          {
            headers: {
              'content-type': 'application/json'
